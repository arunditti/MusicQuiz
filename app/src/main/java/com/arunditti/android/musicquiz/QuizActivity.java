...
package com.arunditti.android.musicquiz;
...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create an inner class that extends MediaSessionCompat.Callbacks, and override the onPlay(), onPause(), and onSkipToPrevious() callbacks. Pass an instance of this class into the MediaSession.setCallback() method in the method you created in TODO 1.
...
// Create a method that shows a MediaStyle notification with two actions (play/pause, skip to previous). Clicking on the notification should launch this activity. It should take one argument that defines the state of MediaSession.
    ...
    // Call MediaButtonReceiver.handleIntent and pass in the incoming intent as well as the MediaSession object to forward the intent to the MediaSession.Callbacks.
    /**
